...
ggsave(umap, filename = paste0("export/combined_postfilter_peak_lsi_clusters0.5_UMAP.pdf"), width = 8, height = 8)
```

```{r}
umap <- DimPlot(object = combined, label = TRUE, group.by = "orig.ident", reduction = "umap") + NoLegend()
ggsave(umap, filename = paste0("export/combined_postfilter_peak_lsi_2_orig.ident_UMAP.pdf"), width = 8, height = 8)
```
