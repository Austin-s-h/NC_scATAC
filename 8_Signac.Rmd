...
combined.peaks <- GenomicRanges::reduce(
  x = c(
    peaks_list[["HH6"]],
    peaks_list[["HH8"]],
    peaks_list[["HH10"]],
...
combined.peaks
combined.peaks <- combined.peaks[!duplicated(combined.peaks), ]
saveRDS(combined.peaks, file = "export/peaks/combined_5000b_peakset_gr.rds", 
  compress = FALSE)
```
...
combined.peaks <- readRDS(file = "export/peaks/combined_5000b_peakset_gr.rds")
