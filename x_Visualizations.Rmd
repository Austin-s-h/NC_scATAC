...
plotPDF(heatmap7, name = "Plot-sensory-neuron-Motif-Pseudotime-Heatmap.pdf", ArchRProj = projNC, addDOC = FALSE, width = 8, height = 10)
...
p10 <- plotTrajectory(projNC, trajectory = "C2END", colorBy = "MotifMatrix",
