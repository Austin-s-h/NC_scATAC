...
p9b <- plotTrajectory(projNC, trajectory = "C10END",
                          colorBy = "cellColData", name = "hour_adj_pseudotime",
                          plotAs = "points", addArrow = F, embedding = "UMAP", rastr = F)
plotPDF(p9b[[1]], name = "Plot-UMAP-Pseudotime-mesenchyme.pdf", ArchRProj = projNC, addDOC = FALSE, width = 8, height = 8)
...
p9c <- plotTrajectory(projNC, trajectory = "C5END",
                          colorBy = "cellColData", name = "hour_adj_pseudotime",
                          plotAs = "points", addArrow = F, embedding = "UMAP", rastr = F)
plotPDF(p9c[[1]], name = "Plot-UMAP-Pseudotime-Neural2.pdf", ArchRProj = projNC, addDOC = FALSE, width = 8, height = 8)
...
p9d <- plotTrajectory(projNC, trajectory = "C2END",
                          colorBy = "cellColData", name = "hour_adj_pseudotime",
                          plotAs = "points", addArrow = F, embedding = "UMAP", rastr = F)
plotPDF(p9d[[1]], name = "Plot-UMAP-Pseudotime-SensoryGlia.pdf", ArchRProj = projNC, addDOC = FALSE, width = 8, height = 8)
...
p9e <- plotTrajectory(projNC, trajectory = "C9END",
                          colorBy = "cellColData", name = "hour_adj_pseudotime",
                          plotAs = "points", addArrow = F, embedding = "UMAP", rastr = F)
plotPDF(p9e[[1]], name = "Plot-UMAP-Pseudotime-SensoryNeurons.pdf", ArchRProj = projNC, addDOC = FALSE, width = 8, height = 8)
...
p9f <- plotTrajectory(projNC, trajectory = "C1END",
                          colorBy = "cellColData", name = "hour_adj_pseudotime",
                          plotAs = "points", addArrow = F, embedding = "UMAP", rastr = F)
plotPDF(p9f[[1]], name = "Plot-UMAP-Pseudotime-Melanocytes.pdf", ArchRProj = projNC, addDOC = FALSE, width = 8, height = 8)
...
p9g <- plotTrajectory(projNC, trajectory = "C7END",
                          colorBy = "cellColData", name = "hour_adj_pseudotime",
                          plotAs = "points", addArrow = F, embedding = "UMAP", rastr = F)
plotPDF(p9g[[1]], name = "Plot-UMAP-Pseudotime-Neural1.pdf", ArchRProj = projNC, addDOC = FALSE, width = 8, height = 8)
...
# Heatmap of all differential enriched genes.
...
## In-vivo enhancer images
```{r plot peak accessibility}
# 2−42661574−42662731
# 27−5656060−5657658
# 1−173791046−173792605
prev_locations <- makeGRangesFromDataFrame(data.frame(chr = c("2","27","1"),
                                                      start = c("42661574","5656060","173791046"),
                                                      end = c("42662731","5657658","173792605")))

atac_peaks.gr <- getPeakSet(projNC)

plotting_enhancers.gr <- atac_peaks.gr[atac_peaks.gr %over% prev_locations]

temp <- getMarkerFeatures(projNC, "PeakMatrix")

plotting_enhancers <- c("1-173791114-173792531",
                        "2-42661783-42662544",
                        "27-5656219-5656425",
                        "27-5656717-5657554")
  
plotting_motifs <- getFeatures(projNC, select = paste(plotting_enhancers, collapse="|"), useMatrix = "PeakMatrix")
