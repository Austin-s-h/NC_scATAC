...
trajectory5 <- c("C4", "C3","C5") # Neural 2
trajectory6 <- c("C4", "C6", "C7") # Neural 1
...
saveArchRProject(ArchRProj = projNC, outputDirectory = "/data/Austin/10XscATAC/ArchR_data_final", load = TRUE)
```
...
# Export each cluster as a bed file
